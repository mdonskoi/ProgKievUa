...
import java.util.regex.Pattern;
    ...
    class Serializer{
        public static void serialize(Object object, BufferedWriter bw, int level) throws IOException, IllegalAccessException {
            if (null == bw) bw = new BufferedWriter(new FileWriter("/home/administrator/Рабочий стол/In/serialize.txt"));
        ...
        if (null == br) br = new BufferedReader(new FileReader("/home/administrator/Рабочий стол/Out/serialize.txt"));
